...
export class AddUserPhone1721886522184 implements MigrationInterface {
    name = 'AddUserPhone1721886522184'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "playLists" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_9b4ce3ae740338c12c729367617" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "playLists" ADD CONSTRAINT "FK_59c0e4ca8d69c4724f9cbe0c50f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "playLists" DROP CONSTRAINT "FK_59c0e4ca8d69c4724f9cbe0c50f"`);
